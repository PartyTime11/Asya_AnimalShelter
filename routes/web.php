...
Route::get('/api/animals', [AnimalShelterController::class, 'showAnimals'])->name('Animal_Shelter.animals.index');
Route::post('/api/animals', [AnimalShelterController::class, 'store'])->name('animals.store');
